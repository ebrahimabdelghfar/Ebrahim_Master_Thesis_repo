...
per-wheel forces as ground truth. Transplanted unchanged from a 1:10 platform
it converges on a tire with less than half the vehicle's grip ceiling and most
Pacejka coefficients railed: not a solver or tuning failure but a loss of
...
quantities, not coefficient bounds. Over three timed laps on a surface
\SI{33}{\percent} below the one its prior was measured on, no coefficient
rails, axle cornering stiffness is recovered to \SI{3}{\percent} and the peak
factor to \SI{11}{\percent}, against a railed peak factor and a
\SI{125}{\percent} stiffness error for the inherited configuration. All results
