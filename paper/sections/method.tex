...
lock. That is deliberate: the sweep is a \emph{virtual} rollout of the
...
optimisation library~\cite{virtanen2020scipy}. The prior carries the measured
tire of Table~\ref{tab:ref}.
...
\SI{240.0}{\kilo\gram} against the \SI{269.8}{\kilo\gram} the wheels actually
carry biased $\mu$ \SI{11}{\percent} low on its own---the \SI{29.8}{\kilo\gram}
shortfall taken on the \SI{269.8}{\kilo\gram} the wheels carry---until the
...
The identifier runs as a single ROS~2 node at \SI{20}{\hertz} with a rolling
