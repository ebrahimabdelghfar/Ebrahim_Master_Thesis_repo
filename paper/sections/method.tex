...
The rest of this subsection states both and why they were chosen; their
measured effect is an open ablation axis (Section~\ref{subsec:ablation}).
...
data spans \SIrange{11}{27}{\meter\per\second}, a $2.5\times$ range of the
...
Neither (i) nor (ii) addresses the degeneracy, and both were verified as
...
from the first crossing of the raceline's $s=0$, so the drive from the spawn
point up to the start line is an untimed out-lap. This level is
