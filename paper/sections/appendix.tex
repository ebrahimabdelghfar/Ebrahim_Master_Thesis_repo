...
at $T_{s}=\SI{0.035}{\second}$ (\texttt{nn\_params.yaml: sample\_dt}), matched
to the server's \SI{0.033}{\second} step and not to the \SI{50}{\hertz}
acquisition timer (Section~\ref{subsec:data}).
