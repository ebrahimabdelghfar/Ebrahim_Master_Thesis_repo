...
def generate_launch_description():
    ...
    args = [
        ...
        DeclareLaunchArgument('integration_method', default_value='rk4',
                              description='ODE solver: euler, heun, or rk4'),
    ...
    node = Node(
        ...
        parameters=[
            default_config,
            {
                ...
                'integration_method': LaunchConfiguration('integration_method'),
