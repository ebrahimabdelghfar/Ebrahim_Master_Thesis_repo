...
loop, which is a property of what that loop can identify
...
time and on abrupt drops between laps. We borrow its decay protocol rather than
...
fit~\cite{fiala1954,acosta2017friction} rather than from a camera or from
